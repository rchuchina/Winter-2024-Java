...
public class Homework2 {
    public static void main(String[] args) {
        ...
        boolean isContains_R = countryName2.contains("R");
         ...
         * 2. find if countryName2 starts with Ki
         */
        String countryName2UpperCase = countryName2.toLowerCase();
        System.out.println("\nmethod - toUpperCase()");
        ...
        System.out.println("countryName1 -> " + countryName1);
        System.out.println("countryName2 -> " + countryName2);
        boolean isCountryName1EqualsIgnoreCase_countryName2 =  countryName2.equalsIgnoreCase(countryName2);
        ...
        System.out.println("\nmethod - replace()");
        System.out.println("countryName1 -> " + countryName1);
        String replace_D_SiGMa = countryName1.replace("D", "SiGMa");
        System.out.println("countryName1 after replace 'D' with 'SiGMa' -> " + replace_D_SiGMa);
